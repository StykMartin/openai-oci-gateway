...
public class ChatCompletionRequestAssistantMessage extends ChatCompletionRequestMessage {
     ...
     *
     * <p>The content must be non-null and not blank; validation constraints enforce this.
     *
     ...
     *
     * <p>The message content is not initialized by this constructor and must be set separately; the
     * content is validated to be non-null and non-blank.
     */
     ...
     *
     * @return the assistant message content; will be a non-null, non-blank string as validated by
