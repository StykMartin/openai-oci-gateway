...
public class ChatCompletionRequestDeveloperMessage extends ChatCompletionRequestMessage {
     ...
     *
     * @param content the message text; must not be null or blank. This value is mapped from the
     *     JSON property "content" during deserialization.
     */
    @JsonCreator
     ...
     *
     * <p>The `content` field is not initialized by this constructor and should be assigned before
     * validation.
     */
