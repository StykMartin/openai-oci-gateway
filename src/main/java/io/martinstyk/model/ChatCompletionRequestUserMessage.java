...
public class ChatCompletionRequestUserMessage extends ChatCompletionRequestMessage {
     ...
     *
     * <p>Intended for use by serialization/deserialization frameworks.
     */
     ...
     *
     * @param content the message text; must not be null or blank (validated as "Content cannot be
     *     null" and "Content cannot be blank")
     */
