...
public ChatCompletionResponseMessage() {}
     ...
     *
     * @param refusal the refusal message or rationale; may be {@code null} to clear any existing refusal
     */
     ...
     *
     * @return the tool calls mapped from the JSON property "tool_calls", or {@code null} if not present
     */
     ...
     *
     * @param annotations a metadata object (for example a Map or List) representing the `annotations` field from the serialized response; may be null
     */
