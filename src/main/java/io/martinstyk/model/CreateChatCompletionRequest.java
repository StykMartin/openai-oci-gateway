...
public class CreateChatCompletionRequest {
     ...
     *
     * <p>Fields are initialized to their default values; the `stream` field defaults to `false`.
     */
     ...
     *
     * @param messages the list of messages; must not be null or empty. Each element is validated as
     *     a {@code ChatCompletionRequestMessage}.
     */
     ...
     *
     * <p>The value adjusts likelihood of repeated tokens; permitted range is -2 to 2.
     *
     ...
     *
     * @param frequencyPenalty the penalty value between -2.0 and 2.0 (inclusive), or `null` to
     *     unset
     */
     ...
     *
     * @return the temperature value, where 0.0 produces deterministic output and higher values (up
     *     to 2.0) increase randomness; may be {@code null} if unset
     */
     ...
     *
     * @param temperature the temperature value in the range 0 to 2 inclusive; higher values
     *     increase randomness
     */
