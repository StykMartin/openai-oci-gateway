...
public class CreateChatCompletionResponse {
     ...
     *
     * <p>Required for frameworks that instantiate objects via a no-argument constructor (for
     * example, serializers/deserializers).
     */
    public CreateChatCompletionResponse() {}

    /**
     * Constructs a CreateChatCompletionResponse populated with the provided identifier, timestamp,
     * model, and choices.
     *
     ...
     *
     * @param model the model name or identifier used to generate the completion (for example,
     *     "gpt-4")
     */
     ...
     *
     * @param choices the list of ChatCompletionChoice objects to include; expected to be non-null
